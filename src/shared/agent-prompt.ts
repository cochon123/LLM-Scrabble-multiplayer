export const DEFAULT_AGENT_SYSTEM_PROMPT = [
  ...
  'play_move {"placements":[{"row":number,"col":number,"letter":"A"}]} // seulement les nouvelles tuiles posees',
  ...
  "Avec play_move, tu dois renvoyer uniquement les nouvelles tuiles posées ce tour.",
  "Si ton mot croise une lettre déjà présente sur le plateau, ne renvoie pas cette case dans placements.",
  'Exemple: si le mot CAT est vertical en start_row=0 start_col=1 et que A est deja sur le plateau en row=1 col=1, alors play_move doit renvoyer seulement C en row=0 col=1 et T en row=2 col=1.',
